...
const HeroSection = () => {
  return (
    <section className="breakout relative pb-12 pt-16">
      <div className="relative flex items-center justify-between gap-40 max-lg:flex-col lg:gap-10">
        ...
        <div className="flex max-w-2xl flex-col items-center justify-center gap-4 rounded-3xl border border-neutral-800 bg-neutral-900 px-6 py-20 text-center sm:mx-8 sm:min-h-[800px]">
